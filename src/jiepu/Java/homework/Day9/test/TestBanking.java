...
public class TestBanking {
    public static void main(String[] args)
    {
        ...
        System.out.println(cust1.getName() + "'s account balance is " +
                acc1.getBalance());
        acc1.deposit(1000.0);
        System.out.println(cust1.getName() + "'s account balance is " +
                acc1.getBalance());
        ...
        System.out.println(cust2.getName() + "'s account balance is " +
                acc2.getBalance() + " and overdraft is " + acc2.getOverdraft());
        acc2.deposit(1000.0);
        System.out.println(cust2.getName() + "'s account balance is " +
                acc2.getBalance() + " and overdraft is " + acc2.getOverdraft());
